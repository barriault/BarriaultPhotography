...
Tabulous.setup do |config|
  ...
  config.tabs do
    [
      ...
      #------------------------------------------------------------------------------------------------------#
      [    :photograqphy_tab ,    'Photography'   ,    photography_path     ,    true        ,    true        ],
      [    :blog_tab         ,    'Blog'          ,    blog_path            ,    true        ,    true        ],
      [    :programming_tab  ,    'Programming'   ,    programming_path     ,    true        ,    true        ],
      [    :about_tab        ,    'About'         ,    about_path           ,    true        ,    true        ],
      [    :contact_tab      ,    'Contact'       ,    contact_path         ,    true        ,    true        ],
      #------------------------------------------------------------------------------------------------------#
      #    TAB NAME        |    DISPLAY TEXT    |    PATH                  |    VISIBLE?    |    ENABLED?    #
      #------------------------------------------------------------------------------------------------------#
    ]
  ...
  config.actions do
    [
      ...
      #------------------------------------------------------------#
      #[    :welcome      ,    :all_actions    ,    :photograqphy_tab],
      [    :blog         ,    :all_actions    ,    :blog_tab        ],
      [    :programming  ,    :all_actions    ,    :programming_tab ],
      [    :about        ,    :all_actions    ,    :about_tab       ],
      [    :contact      ,    :all_actions    ,    :contact_tab     ],
      #------------------------------------------------------------#
      #    CONTROLLER    |    ACTION          |    TAB             #
      #------------------------------------------------------------#
    ]
